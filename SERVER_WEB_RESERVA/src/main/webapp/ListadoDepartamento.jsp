...
.submenu {
	display: none;
	position: absolute;
	/* Asegura que se despliegue sobre otros elementos */
	list-style: none;
...
<body>
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item"><a class="nav-link active"
						href="departamento?opcion=buscarDepartamento">Mant.
							Departamento</a></li>
					<li class="nav-item"><a class="nav-link"
					...
					<li class="nav-item"><a class="nav-link" href="#">Reportes</a>
						...
						<ul class="submenu">
							<li><a class="submenu-link"
								href="cliente?opcion=listarReporteCliente">Clientes que mas
									reservan</a></li>
							<li><a class="submenu-link"
								href="departamento?opcion=listarReporteDepartamento">Departmentos
									mas reservados</a></li>
						</ul></li>
	...
	<input class="botoncito" type="button" value="Agregar departamento"
		onclick="window.location.href='RegistrarDepartamento.jsp'">
	<hr>
	<form action="departamento" method="post">
		...
		<div class="d-flex justify-content-center">
			<label for="IdBuscar">ID:</label> <input type="number" id="IdBuscar"
				...
				placeholder="Ingrese el ID del departamento a buscar" min="1">
		...
		<table class="table table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td><img src="<%=departamento.getImagenDepartamento()%>"
						alt="Imagen Departamento" style="width: 100px; height: auto;" />
					</td>
					<td><a
						href="departamento?opcion=detalle&idDepartamento=<%=departamento.getIdDepartamento()%>"
						class="btn btn-success">Ver detalle</a></td>
					<td><a
						href="departamento?opcion=eliminar&id=<%=departamento.getIdDepartamento()%>"
						class="btn btn-danger"
						onclick="return confirm('¿Estás seguro de que deseas eliminar este departamento?');">Eliminar</a>
						<a
						href="departamento?opcion=modificar&id=<%=departamento.getIdDepartamento()%>"
			...
			-->
					<td colspan="6" class="text-center text-danger">No existe el
						departamento con el ID ingresado</td>
				</tr>
				<%
				...
				%>
				<tr>
					<td colspan="6" class="text-center text-warning">No se
						encuentran departamentos registrados</td>
				</tr>
				<%
				} // Llave de cierre de else if
				else {
