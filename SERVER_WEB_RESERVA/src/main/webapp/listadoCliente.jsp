						...
						<ul class="submenu">
							<li><a class="submenu-link"
								href="cliente?opcion=listarReporteCliente">Clientes que mas
									reservan</a></li>
							<li><a class="submenu-link"
								href="departamento?opcion=listarReporteDepartamento">Departamentos
									mas reservados</a></li>
						</ul></li>
		...
		<table class="table table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td><a
						href="cliente?opcion=detalle&idCliente=<%=cliente.getId_Cliente()%>"
						class="btn btn-success">Ver detalle</a></td>
					<td><a
						href="cliente?opcion=eliminar&id=<%=cliente.getId_Cliente()%>&correo=<%=cliente.getCorreo()%>"
						class="btn btn-danger"
						onclick="return confirm('¿Estás seguro de que deseas eliminar este Empleado?');">Eliminar</a>
						<a href="cliente?opcion=modificar&id=<%=cliente.getId_Cliente()%>"
			...
			-->
					<td colspan="8" class="text-center text-danger">No existe el
				...
				%>
				<tr>
					<td colspan="8" class="text-center text-warning">No se
						encuentran empleado registrados</td>
				</tr>
				<%
				} // Llave de cierre de else if
				else {
